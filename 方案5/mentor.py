...
class MENTOR(GeneralRecommender):
	...
	user_nodes, pos_item_nodes, neg_item_nodes = interaction[0], interaction[1], interaction[2]
        ...
        final_features = (fine_grained_image + fine_grained_text + coarse_grained_embeds) 
        final_features = self.mlp5(final_features)
        ...
        user_rep = user_rep + final_features[:self.n_users]
        item_rep = item_rep + final_features[self.n_users:]
